...
/**
 * An asynchronous log handler which is used to write to a handler or group of
 * handlers which are "slow" or introduce some degree of latency.
 */
public class AsyncHandler extends ExtHandler {
	...
	private static final AtomicIntegerFieldUpdater<AsyncHandler> stateUpdater = AtomicIntegerFieldUpdater.newUpdater(
			AsyncHandler.class, "state");
	 ...
	 * @param threadFactory the thread factory to use to construct the handler
	 * thread
	 */
