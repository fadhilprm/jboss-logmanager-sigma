...
public final class LoggerTests {
	...
	public void testCategories() {
		assertNotNull("Logger not created with category: " + LoggerTests.class.getName(), Logger
				.getLogger(LoggerTests.class.getName()));
		...
		assertNotNull("Logger not created with category: random.chars.`~!@#$%^&*()-=_+[]{}\\|;':\",.<>/?", Logger
				.getLogger("random.chars.`~!@#$%^&*()-=_+[]{}\\|;':\",.<>/?"));
	}
